<div>
    ...
    <div id="footer" class="footer">
        <div class="fixed bottom-4 left-4 flex flex-col items-center space-y-2" style="z-index: 999;">
            <a href="https://wa.me/2349093189011">
        ...
        <div class="footer-main bg-surface">
            <div class="container">
                <div class="content-footer md:py-[60px] py-10 flex justify-between flex-wrap gap-y-8">
                    <div class="company-infor pr-7">
                        <a href="/" class="logo inline-block">
                            <div class="heading3 w-fit">{{config_get("site_name", "Roluxe")}}</div>
                        </a>
                        <div class="flex gap-3 mt-3">
                            ...
                            <div class="flex flex-col">
                                <span class="">{{config_get("contact_email", "admin@roluxaccessories")}}</span>
                                <span class="mt-[14px]">{{config_get("contact_phone", "admin@roluxaccessories")}}</span>
                                <span class="mt-3 pt-1">{{config_get("contact_address", "")}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="right-content flex flex-wrap gap-y-8">
                        <div class="list-nav flex flex-wrap justify-between max-md:basis-full gap-4">
                            <div class="item flex flex-col">
                                <div class="text-button-uppercase pb-3">Infomation</div>
                                <a class="caption1 has-line-before duration-300 w-fit" href="{{route('contact')}}">Contact
                                    us
                                </a>
                                <a class="caption1 has-line-before duration-300 w-fit pt-2" href="{{route('faqs')}}">
                                    FAQs
                                </a>
                            </div>
                            <div class="item flex flex-col">
                                <div class="text-button-uppercase pb-3">Shop</div>
                                <a class="caption1 has-line-before duration-300 w-fit" href="{{route('collection')}}">Collections</a>
                                <a class="caption1 has-line-before duration-300 w-fit pt-2" href="{{route('shop')}}">Shop </a>

                                <a class="caption1 has-line-before duration-300 w-fit pt-2" href="{{route('blog')}}">Blog
                                </a>
                            </div>
                            <div class="item flex flex-col">
                                ...
                                <a class="caption1 has-line-before duration-300 w-fit pt-2" href="{{route('privacy.policy')}}">Privacy
                                    Policy</a>
                                <a class="caption1 has-line-before duration-300 w-fit pt-2" href="{{route('order.tracking')}}">Return & Refund</a>
                            </div>
                        </div>
                        <div class="newsletter basis-1/4 pl-7 max-md:basis-full max-md:pl-0">
                ...
                <div class="footer-bottom py-3 flex items-center justify-between gap-5 max-lg:justify-center max-lg:flex-col border-t border-line">
                    <div class="left flex items-center gap-8">
                        <div class="copyright caption1 text-secondary">©2025 Roluxeaccessories. All Rights Reserved.</div>
    ...
    @livewire('components.modal-cart-block')
    ...
    @livewire("components.quick-view-modal")
</div>
