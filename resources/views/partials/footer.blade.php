                ...
                <div class="content-footer md:py-[60px] py-10 flex justify-between flex-wrap gap-y-8">
                    <div class="company-infor basis-1/4 max-lg:basis-full pr-7">
                        ...
                        <div class="flex gap-3 mt-3">
                            ...
                            <div class="flex flex-col">
                                <span class="">aseyeronke25@gmail.com</span>
                                <span class="mt-[14px]">+234 909 318 9011</span>
                                <span class="mt-3 pt-1">142 Raufu Baruwa, Itire Surulere, Lagos.</span>
                            </div>
                        </div>
                    </div>
                    <div class="right-content flex flex-wrap gap-y-8 basis-3/4 max-lg:basis-full">
                        ...
                        <div class="newsletter basis-1/3 pl-7 max-md:basis-full max-md:pl-0">
                            <div class="list-social flex items-center gap-6 mt-4">
                                <a href="https://www.facebook.com/share/19Z7Qkt7QH/?mibextid=wwXIfr" target="_blank">

                                    <div class="ph ph-facebook-logo text-2xl text-black"></div>
                                </a>
                                <a href="https://www.instagram.com/roluxe_accessories?igsh=MW52dmZqZGM5dnNuaQ%3D%3D&utm_source=qr/" target="_blank">
