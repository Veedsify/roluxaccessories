                    ...
                    <div class="list-img md:w-1/2 md:pr-[45px] w-full flex-shrink-0">
                        <div class="sticky">
                            <div class="swiper mySwiper2 rounded-2xl overflow-hidden swiper-initialized swiper-horizontal swiper-backface-hidden">
                                <div class="swiper-wrapper" id="swiper-wrapper-f6523cc3b5936b65" aria-live="polite">
                                    <!--  -->
                                    <div class="swiper-slide popup-link swiper-slide-active" style="width: 333px;" role="group" aria-label="1 / 4">
                                        <img src="./assets/images/product/fashion/1-1.png" alt="img" class="w-full aspect-[3/4] object-cover">
                                    </div>
                                    <div class="swiper-slide popup-link swiper-slide-next" style="width: 333px;" role="group" aria-label="2 / 4">
                                        <img src="./assets/images/product/fashion/1-2.png" alt="img" class="w-full aspect-[3/4] object-cover">
                                    </div>
                                    <div class="swiper-slide popup-link" style="width: 333px;" role="group" aria-label="3 / 4">
                                        <img src="./assets/images/product/fashion/1-3.png" alt="img" class="w-full aspect-[3/4] object-cover">
                                    </div>
                                    <div class="swiper-slide popup-link" role="group" aria-label="4 / 4" style="width: 333px;">
                            ...
                            <div class="swiper mySwiper swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden swiper-thumbs">
                                <div class="swiper-wrapper" id="swiper-wrapper-dc7536ef2486b651" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                                    <!--  -->
                                    <div class="swiper-slide swiper-slide-visible swiper-slide-fully-visible swiper-slide-active swiper-slide-thumb-active" style="width: 333px;" role="group" aria-label="1 / 4">
                                        <img src="./assets/images/product/fashion/1-1.png" alt="img" class="w-full aspect-[3/4] object-cover">
                                    </div>
                                    <div class="swiper-slide swiper-slide-visible swiper-slide-next" style="width: 333px;" role="group" aria-label="2 / 4">
                                        <img src="./assets/images/product/fashion/1-2.png" alt="img" class="w-full aspect-[3/4] object-cover">
                                    </div>
                                    <div class="swiper-slide swiper-slide-visible" style="width: 333px;" role="group" aria-label="3 / 4">
                                        <img src="./assets/images/product/fashion/1-3.png" alt="img" class="w-full aspect-[3/4] object-cover">
                                    </div>
                                    <div class="swiper-slide swiper-slide-visible" role="group" aria-label="4 / 4" style="width: 333px;">
                                        <img src="./assets/images/product/fashion/1-4.png" alt="img" class="w-full aspect-[3/4] object-cover">
                                    </div>
                                </div>
                                <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
                    ...
                    <div class="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2" data-item="1">
                        <div class="flex justify-between">
                            <div>
                                ...
                                <div class="product-name heading4 mt-1">mesh shirt</div>
                            </div>
                        ...
                        <div class="flex items-center gap-3 flex-wrap mt-5 pb-6 border-b border-line">
                            <div class="product-price heading5">$45.00</div>
                            <div class="w-px h-4 bg-line"></div>
                            <div class="product-origin-price font-normal text-secondary2"><del>$55.00</del></div>
                            <div class="product-sale caption2 font-semibold bg-green px-3 py-0.5 inline-block rounded-full">-18%</div>
                            <div class="product-description text-secondary mt-3">Keep your home organized, yet elegant with storage cabinets by Onita Patio Furniture. Traditionally designed, they are perfect to be used in the any place where you need to store.</div>
                        </div>
                        <div class="list-action mt-6">
                            <div class="sold-block flex justify-between flex-wrap gap-4">
                                ...
                                <div class="right sm:w-3/4">
                                    <div class="progress h-2 rounded-full overflow-hidden bg-line relative">
                                        <div class="percent-sold absolute top-0 left-0 h-full bg-red" style="width: 12%;"></div>
                                    </div>
                                    <div class="flex items-center gap-1 mt-2">
                                        <span class="percent-sold-number">12% Sold -</span>
                                        <span class="text-secondary">Only <span class="remaining-number">88</span> item(s) left in stock!</span>
                                    </div>
                                </div>
                            </div>
                            <div class="choose-color mt-5">
                                ...
                                <div class="list-color flex items-center gap-2 flex-wrap mt-3">
                                    ...
                                    <div class="color-item w-12 h-12 rounded-xl duration-300 relative">
                                        <img src="./assets/images/product/color/yellow.png" alt="color" class="rounded-xl">
                                        <div class="tag-action bg-black text-white caption2 capitalize px-1.5 py-0.5 rounded-sm">
                                            yellow
                                        </div>
                                    </div>
                            ...
                            <div class="more-infor mt-6">
                                ...
                                <div class="flex items-center gap-1 mt-3">
                                    ...
                                    <div class="list-category text-secondary">
                                        <a href="shop-breadcrumb1.html" class="text-secondary">fashion,</a>
                                        <a href="shop-breadcrumb1.html" class="text-secondary"> women</a>
                                    </div>
                                </div>
                                <div class="flex items-center gap-1 mt-3">
                        ...
                        <div class="list-review lg:w-7/12 lg:pl-[60px]">
                            <div class="item pb-6 border-b border-line">
                                <div class="heading flex items-center justify-between">
                                    <div class="user-infor flex gap-4">
                                        <div class="avatar">
                                            <img src="./assets/images/avatar/1.png" alt="img" class="w-[52px] aspect-square rounded-full">
                                        </div>
                                        <div class="user">
                                            <div class="flex items-center gap-2">
                            ...
                            <div class="item mt-6 pb-6 border-b border-line">
                                <div class="heading flex items-center justify-between">
                                    <div class="user-infor flex gap-4">
                                        <div class="avatar">
                                            <img src="./assets/images/avatar/2.png" alt="img" class="w-[52px] aspect-square rounded-full">
                                        </div>
                                        <div class="user">
                                            <div class="flex items-center gap-2">
                            ...
                            <div class="item mt-6">
                                <div class="heading flex items-center justify-between">
                                    <div class="user-infor flex gap-4">
                                        <div class="avatar">
                                            <img src="./assets/images/avatar/3.png" alt="img" class="w-[52px] aspect-square rounded-full">
                                        </div>
                                        <div class="user">
                                            <div class="flex items-center gap-2">
                ...
                <div class="list-product six-product hide-product-sold relative section-swiper-navigation style-outline style-small-border md:mt-10 mt-6">
                    ...
                    <div class="swiper swiper-list-product h-full relative swiper-initialized swiper-horizontal swiper-backface-hidden">
                        <div class="swiper-wrapper" id="swiper-wrapper-d4efcb5895b1e2a8" aria-live="polite">
                            <!-- List six product -->
                            <div class="swiper-slide swiper-slide-active" style="width: 158.5px; margin-right: 16px;" role="group" aria-label="1 / 6" data-swiper-slide-index="0">
                                <div class="product-item grid-type" data-item="6">
                                    <div class="product-main cursor-pointer block" data-item="6">
                                        <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                            ...
                                            <div class="product-img w-full h-full aspect-[3/4]">
                                                <img key="0" class="w-full h-full object-cover duration-700" src="./assets/images/product/fashion/6-1.png" alt="img"><img key="1" class="w-full h-full object-cover duration-700" src="./assets/images/product/fashion/6-2.png" alt="img">
                                            </div>
                                        ...
                                        <div class="product-infor mt-4 lg:mb-7">
                                            <div class="product-sold sm:pb-4 pb-2">
                                                <div class="progress bg-line h-1.5 w-full rounded-full overflow-hidden relative">
                                                    <div class="progress-sold bg-red absolute left-0 top-0 h-full" style="width: 9%">
                                                    </div>
                                                </div>
                                                <div class="flex items-center justify-between gap-3 gap-y-1 flex-wrap mt-2">
                                                    <div class="text-button-uppercase">
                                                        ...
                                                        <span class="max-sm:text-xs">19</span>
                                                    </div>
                                                    <div class="text-button-uppercase">
                                                        <span class="text-secondary2 max-sm:text-xs">Available:
                                                        </span>
                                                        <span class="max-sm:text-xs">181</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="list-color list-color-image max-md:hidden flex items-center gap-3 flex-wrap duration-500">
                                                ...
                                                <div class="color-item w-12 h-12 rounded-xl duration-300 relative" key="0">
                                                    <img src="./assets/images/product/color/green.png" alt="color" class="rounded-xl w-full h-full object-cover">
                                            ...
                                            <div class="product-price-block flex items-center gap-2 flex-wrap mt-1 duration-300 relative z-[1]">
                                                <div class="product-price text-title">$36.00</div>
                            ...
                            <div class="swiper-slide swiper-slide-next" style="width: 158.5px; margin-right: 16px;" role="group" aria-label="2 / 6" data-swiper-slide-index="1">
                                <div class="product-item grid-type" data-item="7">
                                    <div class="product-main cursor-pointer block" data-item="7">
                                        <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                            ...
                                            <div class="product-img w-full h-full aspect-[3/4]">
                                                <img key="0" class="w-full h-full object-cover duration-700" src="./assets/images/product/fashion/7-1.png" alt="img"><img key="1" class="w-full h-full object-cover duration-700" src="./assets/images/product/fashion/7-2.png" alt="img">
                                            </div>

                                            <div class="countdown-time-block py-1.5 flex items-center justify-center">
                                                <div class="text-xs font-semibold uppercase text-red">
                                                    <span class="countdown-day">0-236</span>
                                                    <span>D : </span>
                                                    <span class="countdown-hour">0-15</span>
                                                    <span>H : </span>
                                                    <span class="countdown-minute">0-11</span>
                                                    <span>M : </span>
                                                    <span class="countdown-second">0-16</span>
                                                    <span>S</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="product-infor mt-4 lg:mb-7">
                                            <div class="product-sold sm:pb-4 pb-2">
                                                <div class="progress bg-line h-1.5 w-full rounded-full overflow-hidden relative">
                                                    <div class="progress-sold bg-red absolute left-0 top-0 h-full" style="width: 27%">
                                                    </div>
                                                </div>
                                                <div class="flex items-center justify-between gap-3 gap-y-1 flex-wrap mt-2">
                                                    <div class="text-button-uppercase">
                                                        ...
                                                        <span class="max-sm:text-xs">22</span>
                                                    </div>
                                                    <div class="text-button-uppercase">
                                                        <span class="text-secondary2 max-sm:text-xs">Available:
                                                        </span>
                                                        <span class="max-sm:text-xs">58</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="list-color py-2 max-md:hidden flex items-center gap-3 flex-wrap duration-500">
                                                ...
                                                <div key="2" class="color-item w-8 h-8 rounded-full duration-300 relative" style="background-color:#F6EFDD;">
                            ...
                            <div class="swiper-slide" style="width: 158.5px; margin-right: 16px;" role="group" aria-label="3 / 6" data-swiper-slide-index="2">
                                <div class="product-item grid-type" data-item="8">
                                    <div class="product-main cursor-pointer block" data-item="8">
                                        <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                            <div class="product-tag text-button-uppercase text-white bg-red px-3 py-0.5 inline-block rounded-full absolute top-3 left-3 z-[1]">Sale</div>
                                            <div class="list-action-right absolute top-3 right-3 max-lg:hidden">
                                                <div class="add-wishlist-btn w-[32px] h-[32px] flex items-center justify-center rounded-full bg-white duration-300 relative">
                                            ...
                                            <div class="product-img w-full h-full aspect-[3/4]">
                                                <img key="0" class="w-full h-full object-cover duration-700" src="./assets/images/product/fashion/8-1.png" alt="img"><img key="1" class="w-full h-full object-cover duration-700" src="./assets/images/product/fashion/8-2.png" alt="img">
                                            </div>
                                        ...
                                        <div class="product-infor mt-4 lg:mb-7">
                                            <div class="product-sold sm:pb-4 pb-2">
                                                <div class="progress bg-line h-1.5 w-full rounded-full overflow-hidden relative">
                                                    <div class="progress-sold bg-red absolute left-0 top-0 h-full" style="width: 45%">
                                                    </div>
                                                </div>
                                                <div class="flex items-center justify-between gap-3 gap-y-1 flex-wrap mt-2">
                                                    <div class="text-button-uppercase">
                                                        ...
                                                        <span class="max-sm:text-xs">45</span>
                                                    </div>
                                                    <div class="text-button-uppercase">
                                                        <span class="text-secondary2 max-sm:text-xs">Available:
                                                        </span>
                                                        <span class="max-sm:text-xs">55</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="product-name text-title duration-300">Kimono sleeve top</div>
                            ...
                            <div class="swiper-slide" style="width: 158.5px; margin-right: 16px;" role="group" aria-label="4 / 6" data-swiper-slide-index="3">
                                <div class="product-item grid-type" data-item="9">
                                    <div class="product-main cursor-pointer block" data-item="9">
                                        <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                            <div class="product-tag text-button-uppercase bg-green px-3 py-0.5 inline-block rounded-full absolute top-3 left-3 z-[1]">New</div>
                                            <div class="list-action-right absolute top-3 right-3 max-lg:hidden">
                                                <div class="add-wishlist-btn w-[32px] h-[32px] flex items-center justify-center rounded-full bg-white duration-300 relative">
                                            ...
                                            <div class="product-img w-full h-full aspect-[3/4]">
                                                <img key="0" class="w-full h-full object-cover duration-700" src="./assets/images/product/fashion/9-1.png" alt="img"><img key="1" class="w-full h-full object-cover duration-700" src="./assets/images/product/fashion/9-2.png" alt="img">
                                            </div>
                            ...
                            <div class="swiper-slide" style="width: 158.5px; margin-right: 16px;" role="group" aria-label="5 / 6" data-swiper-slide-index="4">
                                <div class="product-item grid-type" data-item="10">
                                    <div class="product-main cursor-pointer block" data-item="10">
                                        <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                            <div class="product-tag text-button-uppercase bg-green px-3 py-0.5 inline-block rounded-full absolute top-3 left-3 z-[1]">New</div>
                                            <div class="list-action-right absolute top-3 right-3 max-lg:hidden">
                                                <div class="add-wishlist-btn w-[32px] h-[32px] flex items-center justify-center rounded-full bg-white duration-300 relative">
                                            ...
                                            <div class="product-img w-full h-full aspect-[3/4]">
                                                <img key="0" class="w-full h-full object-cover duration-700" src="./assets/images/product/fashion/10-1.png" alt="img"><img key="1" class="w-full h-full object-cover duration-700" src="./assets/images/product/fashion/10-2.png" alt="img">
                                            </div>
                                        ...
                                        <div class="product-infor mt-4 lg:mb-7">
                                            <div class="product-sold sm:pb-4 pb-2">
                                                <div class="progress bg-line h-1.5 w-full rounded-full overflow-hidden relative">
                                                    <div class="progress-sold bg-red absolute left-0 top-0 h-full" style="width: 6%">
                                                    </div>
                                                </div>
                                                <div class="flex items-center justify-between gap-3 gap-y-1 flex-wrap mt-2">
                                                    <div class="text-button-uppercase">
                                                    ...
                                                    <div class="text-button-uppercase">
                                                        ...
                                                        <span class="max-sm:text-xs">188</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="product-name text-title duration-300">Raglan Sleeve T-shirt</div>
                                            ...
                                            <div class="list-color list-color-image max-md:hidden flex items-center gap-3 flex-wrap duration-500">
                                                ...
                                                <div class="color-item w-12 h-12 rounded-xl duration-300 relative" key="3">
                            ...
                            <div class="swiper-slide" role="group" aria-label="6 / 6" style="width: 158.5px; margin-right: 16px;" data-swiper-slide-index="5">
                                <div class="product-item grid-type" data-item="11">
                                    <div class="product-main cursor-pointer block" data-item="11">
                                        <div class="product-thumb bg-white relative overflow-hidden rounded-2xl">
                                            <div class="product-tag text-button-uppercase text-white bg-red px-3 py-0.5 inline-block rounded-full absolute top-3 left-3 z-[1]">Sale</div>
                                            <div class="list-action-right absolute top-3 right-3 max-lg:hidden">
                                                <div class="add-wishlist-btn w-[32px] h-[32px] flex items-center justify-center rounded-full bg-white duration-300 relative">
                                            ...
                                            <div class="product-img w-full h-full aspect-[3/4]">
                                                <img key="0" class="w-full h-full object-cover duration-700" src="./assets/images/product/fashion/11-1.png" alt="img"><img key="1" class="w-full h-full object-cover duration-700" src="./assets/images/product/fashion/11-2.png" alt="img">
                                            </div>
                                        ...
                                        <div class="product-infor mt-4 lg:mb-7">
                                            <div class="product-sold sm:pb-4 pb-2">
                                                <div class="progress bg-line h-1.5 w-full rounded-full overflow-hidden relative">
                                                    <div class="progress-sold bg-red absolute left-0 top-0 h-full" style="width: 17%">
                                                    </div>
                                                </div>
                                                <div class="flex items-center justify-between gap-3 gap-y-1 flex-wrap mt-2">
                                                    <div class="text-button-uppercase">
                                                        ...
                                                        <span class="max-sm:text-xs">14</span>
                                                    </div>
                                                    <div class="text-button-uppercase">
                                                        <span class="text-secondary2 max-sm:text-xs">Available:
                                                        </span>
                                                        <span class="max-sm:text-xs">66</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="product-name text-title duration-300">Off-the-Shoulder Blouse</div>
                                            ...
                                            <div class="list-color py-2 max-md:hidden flex items-center gap-3 flex-wrap duration-500">
                                                ...
                                                <div key="1" class="color-item w-8 h-8 rounded-full duration-300 relative" style="background-color:#F6EFDD;">
                                                    <div class="tag-action bg-black text-white caption2 capitalize px-1.5 py-0.5 rounded-sm">white</div>
                                                </div>
                                                <div key="2" class="color-item w-8 h-8 rounded-full duration-300 relative" style="background-color:#8684D4;">
                                                    <div class="tag-action bg-black text-white caption2 capitalize px-1.5 py-0.5 rounded-sm">purple</div>
                                                </div>
